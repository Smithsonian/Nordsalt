...
dt$dif_amb_ptemp_transect <- dt$ptemp - dt$mean_amb_ptemp_transect
dt$dif_amb_ptemp_all <- dt$ptemp - dt$mean_amb_ptemp_all
dt$dif_amb_ltemp_transect <- dt$ltemp - dt$mean_amb_ltemp_transect
dt$dif_amb_ltemp_all <- dt$ltemp - dt$mean_amb_ltemp_all
